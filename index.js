...
const playrs_by_tobi = (linguagem.playrs(pushname, hr, total_gp3, bateria))
wew = fs.readFileSync('./base de dados/lib/bot/fotos/login.mp4')
tobi.sendMessage(from, wew, video, {quoted: mek, mimetype: Mimetype.gif, thumbnail:null, caption: playrs_by_tobi})
await requestCash(sender)
break
